...
namespace DashboardMVC.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public ActionResult GetDetails(string type)
        {
            ...
            return PartialView("~/View/Dashboard/GetDetails.cshtml", result);
        }
        public ActionResult TopCustomers()
        {
            ...
            return PartialView("~/View/Dashboard/TopCustomers.cshtml", topFiveCustomers);
        }
